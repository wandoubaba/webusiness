...
$(function () {
    ...
    $('#control-sidebar-right-tab').append($tabButton)
    ...
    // Dark sidebar skins
    var $skinBlue =
        $('<li />', {style: 'float:left; width: 50%; padding: 15px;'})
    ...
    $demoSettings.append('<h4 class="control-sidebar-heading">界面配色</h4>')
    $demoSettings.append($skinsList)

    $tabPane.append($demoSettings)
    $('#control-sidebar-right-tab').after($tabPane)
